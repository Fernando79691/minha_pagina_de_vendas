            ...
            <Conteudo>
                ...
                <div className='beneficios'>
                    <div className='card'>
                        ...
                        <p>Com a proposta comercial
                            você terá uma forma mais
                            profissional de apresentar o
                            seu trabalho.</p>
                    </div>
                    <div className='card'>
                        <img src={dinheiro} alt="icone de dinheiro" />
                        <h4>Adeus Calote!</h4>
                        <p>Com os contratos você não
                            irá sofrer tomando calote
                            nunca mais. Os contratos
                            asseguram ambas as partes,
                            tanto o cliente como o
                            prestador de serviço.</p>
                    </div>
                    <div className='card'>
                        <img src={financeiro} alt="icone financeiro" />
                        <h4>Controle Financeiro</h4>
                        <p>Com a nossa planilha master
                            você será capaz de ter o
                            controle financeiro do seu
                            negócio. Esse é o primeiro
                            passo para um negócio de
                            sucesso.</p>
                    </div>
                    <div className='card'>
                        <img src={organizacao} alt="icone de organizacao" />
                        <h4>Mais Organização</h4>
                        <p>Chega de começar a
                            trabalhar e não saber o que
                            tem que entregar naquele
                            dia. Com os documentos do
                            DOC MASTER você vai
